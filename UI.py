...
help_head = """
================== §bToDoList §r==================
Could also input first chr of commands below, for exam. (§blist->l§r)
...
help_body = {
    ...
    f"§b{prefix} add <name> (<detail>) (<progress>)": "§rAdd/edit <name>, process etc. for args",
    f"§b{prefix} tag": "§rlist all tags",
    f"§b{prefix} tag <tag>": "§rList TODOs under <tag>",
    f"§b{prefix} tag add <name> <tag>": "§rAdd tag to <name>",
    f"§b{prefix} tag del <name> <tag>": "§r为<name>Delete tag",
}
    ...
    for name, list_info in fun.list_dic.items():
        ...
        list_msg = RTextList(
                            ...
                            .h(
                                ...
                                f'§7Latest editor:§6 {fun.list_dic.get(name)["creator"]} §7时间:§6 {fun.list_dic.get(name)["time"]}',
